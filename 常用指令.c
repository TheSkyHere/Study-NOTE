...
添加FAN在位Deasserted
ipmitool_ali -U admin -P admin -H 192.168.0.25 raw 0x0a 0x44    0x24 0x00 0x02 0xf6 0x06 0x9d 0x4d 0x20 0x00 0x04     0x04 0x48 0x88  0x00 0x00 0x00 
...
grep的使用：
grep  "192.168.1" Horsea-ali-MOC-N01-minicom.cap -c （-c只显示数量）
